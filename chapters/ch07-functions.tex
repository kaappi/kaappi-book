...
This requires two recursive cases: when the \code{car} is itself a pair (deep-reverse it before collecting), and when it is an atom (keep it as-is). Use an accumulator for the outer reversal, as in the \code{flatten} example from this chapter.
\end{exercise}
