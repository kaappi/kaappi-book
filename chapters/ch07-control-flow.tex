...
Use named \code{let} for the outer loop, and \code{fold} or a helper function to check each rule. This exercises \code{cond}, \code{when}, named \code{let}, and string operations together.
\end{exercise}
