...
Each clause lists datum values in parentheses. The key is compared using \texttt{eqv?}\index{eqv?}, so this works well with symbols, numbers, and characters---but not strings (use \texttt{cond} with \texttt{string=?} for strings).
