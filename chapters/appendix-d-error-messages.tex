...
\textbf{Cause:} A primitive received an argument of the wrong type. The message names the procedure and shows the offending value---here, \texttt{car} applied to the empty list.

\begin{lstlisting}[style=repl]
> (car '())
; error: type error in 'car': expected pair, got ()
> (+ 1 "two")
; error: type error in '+': got "two"
\end{lstlisting}
