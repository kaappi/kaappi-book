...
\subsection{\texttt{error[KP3002]: type error in 'string-set!': expected mutable string, got \#<string>}}
...
;   expected mutable string, got #<string>
> (vector-set! #(1 2 3) 0 99)
; error[KP3002]: type error in 'vector-set!':
;   expected mutable vector, got #<vector>
\end{lstlisting}
