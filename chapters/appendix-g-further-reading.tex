...
\item[Structure and Interpretation of Computer Programs] \textit{Harold Abelson, Gerald Jay Sussman, and Julie Sussman} (MIT Press, 1996). The classic introduction to computer science using Scheme. Covers abstraction, recursion, interpreters, and compilation. Available free online at \texttt{mitpress.mit.edu/sites/default/files/sicp/index.html}.
