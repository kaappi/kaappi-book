...
Kaappi's \texttt{--sandbox} mode disables the FFI entirely (and, for the same reason, the subprocess library of Section~\ref{sec:subprocesses}). This is useful for running untrusted code:
