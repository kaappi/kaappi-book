...
You now know how to define custom data types with records, control mutability, build clean abstractions, and choose between records and lists. In the next chapter (Chapter~\ref{ch:continuations}), we explore continuations---Scheme's most powerful and unusual control flow mechanism.
