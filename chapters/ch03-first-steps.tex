...
Write a function \code{(power base exp)} that computes $\mathit{base}^{\mathit{exp}}$ using recursion. Assume \code{exp} is a non-negative integer. The base case is: anything raised to the power 0 is 1. The recursive case is: $b^n = b \times b^{n-1}$.
