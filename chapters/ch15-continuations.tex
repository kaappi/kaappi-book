...
Each call to \texttt{counter} resumes the coroutine from where it last yielded. The first call starts the procedure and yields \texttt{"one"}; subsequent calls continue after the corresponding \texttt{yield}.
