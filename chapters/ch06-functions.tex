...
\begin{itemize}
    ...
    \item Variadic functions use a rest parameter, and \texttt{apply} spreads a list into individual arguments.
    \item Procedures can return several results with \texttt{values} and \texttt{call-with-values}.
\end{itemize}
...
The next chapter covers control flow in depth.
