...
The \texttt{tmp} inside the macro and the \texttt{tmp} in the calling code are different bindings---the macro's \texttt{tmp} is automatically renamed to avoid capture. In an unhygienic system (like C's \texttt{\#define}), this would be a bug.
