...
You now know how to extend Scheme's syntax with hygienic, pattern-based macros. This is a capability that few mainstream languages offer. In the next chapter (Chapter~\ref{ch:libraries}), we cover the library system---how to organize code into modules with clean interfaces.
