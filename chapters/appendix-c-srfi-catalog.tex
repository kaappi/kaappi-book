...
11\textbf{*} & \texttt{let-values} and \texttt{let*-values} \\
16\textbf{*} & \texttt{case-lambda} --- procedures with variable arity \\
17 & Generalized \texttt{set!} \\
26\textbf{*} & \texttt{cut} and \texttt{cute} --- partial application notation \\
...
98\textbf{*} & Interface to access environment variables \\
