...
A restricted execution mode (\texttt{--sandbox}) for untrusted code. Disables the FFI, file I/O, \texttt{eval}, \texttt{load}, process context access, and OS threads (Appendix~\ref{app:cli}).
