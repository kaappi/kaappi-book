...
A syntax transformation that rewrites code before it is compiled. Defined with \texttt{define-syntax} and \texttt{syntax-rules} (Chapter~\ref{ch:macros}). See also \emph{hygienic macro}.
